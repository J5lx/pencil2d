...
PENCIL2D_NIGHTLY {
    isEmpty(PENCIL2D_NIGHTLY_BUILD) {
        error("Please add the PENCIL2D_NIGHTLY_BUILD variable with a description of this build!")
    }
    DEFINES += 'PENCIL2D_NIGHTLY_BUILD="\\"$$PENCIL2D_NIGHTLY_BUILD\\""'
}

release:!PENCIL2D_NIGHTLY {
